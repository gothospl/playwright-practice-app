...
test('tooltips', async({page}) => {
    ...
    page.getByRole('tooltip') // only if you have a role tooltip created
...
test('web tables', async({page}) => {
    ...
    //2 get the row based on the value in
...
test('date picker', async({page}) => {
    ...
    await expect(calendarInputField).toHaveValue('Apr 1, 2025')
})